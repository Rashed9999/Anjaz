...
//
// AMIAL-MERCHANT-PROFILE-NULL-001 — **وهذا المسبارُ يحمل ملفَّ تاجرٍ
// دائماً، فالحالةُ المكسورةُ لا يراها هذا المسحُ أبداً.**
//
// تاجرٌ **بلا** صفٍّ في `merchant_profiles` كان يُسقط صفحتين بـ٥٠٠،
// وبقي مستوراً لأنّ القاعدةَ تُفرَّغ قبل المسح فيُخطَّى المسارُ بعذرٍ
// سليم: «لا بيانات لِـid». وظهر بالمصادفة حين بُذرت بياناتُ عرضٍ لسببٍ
// آخر.
//
// **ولا يُقلَب المسبارُ إلى الحالة المكسورة** — فذلك يستبدل عمىً بعمى:
// تُفحص الحالةُ الفارغةُ وتُترك الكاملة. فالحالتان معاً في حارسٍ يصنع
// كلتيهما: `tests/Feature/MerchantWithoutProfileGuardTest.php`.
