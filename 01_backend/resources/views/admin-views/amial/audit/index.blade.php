    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ url()->current() }}" method="GET" class="row g-3">
                ...
                <div class="col-md-3">
                    <label class="form-label">{{ translate('Correlation ID') }}</label>
            ...
            <table class="table table-borderless table-thead-bordered table-align-middle">
                ...
                @forelse($decisions as $d)
                    <tr>
                        ...
                        <td><small class="text-monospace" title="{{ $d->correlation_id }}">{{ IlluminateSupportStr::limit($d->correlation_id, 18) }}</small></td>
                        <td>
                            @switch($d->severity)
