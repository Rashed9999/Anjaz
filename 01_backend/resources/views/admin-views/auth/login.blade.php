            ...
            <div class="auth-card" data-testid="login-card">
                ...
                <form method="POST" action="{{ route('admin.auth.login') }}" data-testid="login-form" id="admin-login-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="login-phone" type="tel" name="phone" class="form-control"
                               data-testid="login-phone" value="{{ old('phone') }}" inputmode="tel"
                               autocomplete="username" placeholder="9677xxxxxxxx" required autofocus>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="login-pin">رمز PIN الوظيفي</label>
                        <input id="login-pin" type="password" name="login_pin"
                               class="form-control pin-control" data-testid="login-pin"
                    ...
                    <button type="submit" class="btn btn-primary w-100 login-submit"
                            data-testid="login-submit" id="admin-login-submit">
                        <span>دخول آمن</span>
