...
class SslCommerzPaymentController extends Controller
{
    ...
    public function __construct(PaymentRequest $payment, User $user)
    {
        ...
        // AMIAL-FIX: قيم فارغة/وضع غير متوقّع كانت تسبب Undefined variable $values
        // فتُسقط أي طلب يلمس المتحكّم (وحتى route:list). نتحقق من $values قبل القراءة.
        if ($config && $values && isset($values->store_id)) {
