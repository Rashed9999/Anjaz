...
class RegistrationDossierService
{
    ...
    public function archiveVerificationSubmission(
        ...
        $snapshot = array_merge([
            ...
            'father_name' => (string) ($subject->father_name ?? ''),
            'grandfather_name' => (string) ($subject->grandfather_name ?? ''),
            'gender' => (string) ($subject->gender ?? ''),
            'country_of_birth' => (string) ($subject->country_of_birth ?? ''),
            'marital_status' => (string) ($subject->marital_status ?? ''),
            'occupation' => (string) ($subject->occupation ?? ''),
            'employer_name' => (string) ($subject->employer_name ?? ''),
            'job_title' => (string) ($subject->job_title ?? ''),
            'work_address' => (string) ($subject->work_address ?? ''),
            'income_source' => (string) ($subject->income_source ?? ''),
            'monthly_income' => (string) ($subject->monthly_income ?? ''),
            'monthly_income_currency' => (string) ($subject->monthly_income_currency ?? ''),
