...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        // AMIAL-FIX(PDF-SIZE): تقليم الخطّ — يُضمّن الحروف المستخدَمة فقط بدل الخطّ
        // العربي كاملاً (~700KB). كان الإيصال ~860KB فينقطع تنزيله على شبكة
        // الجوّال («Connection closed while receiving data»).
