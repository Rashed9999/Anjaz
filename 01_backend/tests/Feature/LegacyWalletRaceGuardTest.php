...
class LegacyWalletRaceGuardTest extends TestCase
{
    ...
    public function test_every_caller_of_the_legacy_path_wraps_it_in_a_transaction(): void
    {
        ...
        // بعد نقل التحويلات والإصدار إلى الخدمات الموحّدة، بقي نداءا عمولة الإحالة
        // فقط للمسار القديم. وجودهما مثبت هنا، وتُراجع المعاملة لكلّ نداء أدناه.
        $this->assertGreaterThanOrEqual(2, $found, 'المسحُ لم يجد نداءَي عمولة الإحالة — الحارسُ معطَّل');
