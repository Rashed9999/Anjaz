...
class PharmacyVerticalBoundaryTest extends TestCase
{
    ...
    public function a_non_pharmacy_merchant_and_its_pos_cannot_open_pharmacy_api(): void
    {
        ...
        // ══════════════════════════════════════════════════════════════
        // **ويُقاس حاجزُ القطاع، لا حاجزُ المقعد.**
        //
        // `EnsurePosDevice` وسيطٌ يسبق المتحكّم، فيردّ جلسةَ نقطةِ بيعٍ
        // بلا جهازٍ مربوطٍ بـ`POS_DEVICE_REQUIRED` **قبل أن يُسأل القطاعُ
        // أصلاً**. والرفضان صحيحان — لكنّ ٤٠٣ من الأوّل **لا يُثبت عزلَ
        // القطاعات في شيء**، ولو سقط حاجزُ الصيدليّة كلَّه لبقي هذا
        // الفحصُ أخضر. (القاعدة الثانية: حارسٌ يمرّ والعطلُ قائمٌ أسوأُ
        // من غيابه.)
        //
        // فيُطفَأ إنفاذُ المقعد في هذه الحالة وحدَها ليصل الطلبُ إلى
        // الحاجز المقصود — **ولا يُلَيَّن أيُّ حاجزٍ منهما**.
        // ══════════════════════════════════════════════════════════════
