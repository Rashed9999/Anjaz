...
class AdminDoorsAreGuardedTest extends TestCase
{
    ...
    private const WRITE_OPEN_BY_DESIGN = [
        ...
        // AMIAL-AUTH-PIN-FORCE-002 — **ولا صلاحيّةَ تحرس هذا عمداً.**
        //
        // الشاشةُ لمن رمزُه أوّليٌّ، **وهو محجوبٌ عن كلّ صفحةٍ أخرى**.
        // فحاجزٌ بصلاحيّةٍ عليها يُنتج سجناً: لا يدخل ولا يستطيع الخروج
        // من الحالة التي حُبس فيها.
        //
        // **وحمايتُه من الهويّة والرمز الحاليّ لا من صلاحيّة**: يعمل على
        // `auth('user')->user()` وحدَه — لا يقبل معرّفاً من الطلب —
        // ويشترط إثباتَ الرمز الحاليّ قبل التبديل، وإلّا صار بابَ
        // استيلاءٍ على جلسةٍ مسروقة. (القاعدة الثامنة.)
        'admin.auth.pin.update' => 'رمزُ دخول الموظّف نفسِه — بإثبات الرمز الحاليّ',
    ];
