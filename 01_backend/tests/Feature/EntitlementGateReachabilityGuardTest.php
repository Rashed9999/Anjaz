 ...
 *
 * ══════════════════════════════════════════════════════════════════════
 * **دفعتان — ستٌّ رُبطت وواحدةٌ تنتظر قرارَ تسعير:**
 *
 * | القدرة | الحكم |
 * |---|---|
 ...
 * | `customers` | **تنتظر قرارَ تسعير** — نهاياتُها هي نفسُها نهاياتُ `debts` المجّانيّة |
 *
...
class EntitlementGateReachabilityGuardTest extends TestCase
{
    ...
    public function paid_capabilities_with_a_screen_and_no_gate_at_all_never_grow(): void
    {
        ...
        $this->assertLessThanOrEqual(1, count($open),
            sprintf(
                "قدراتٌ مدفوعةٌ لها شاشةٌ ولا يحرسها الخادمُ بشيءٍ صارت %d وكانت 1:\n  %s\n\n"
