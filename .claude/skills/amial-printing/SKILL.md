---
name: amial-printing
description: تُستدعى قبل بناء أو تعديل أيّ مستندٍ يُطبع (إيصال · فاتورة · سند · تقرير · تذكرة مطبخ): قوالبُ ومقاساتُ ورقٍ وتوجيهُ طابعاتٍ وطابورٌ وصلاحيّاتٌ وتدقيق — والطباعةُ لا تُغيّر حقيقةً ماليّة.
---
