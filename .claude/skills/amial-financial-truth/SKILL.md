...
description: تُستدعى قبل أيّ حسابٍ ماليٍّ في لوحةٍ أو تقريرٍ أو واجهة: مصدرُ الحقيقة الماليّة واحد — المحرّكُ والدفتر — ولا واجهةَ تحسب رصيداً أو رسماً أو عمولةً بنفسها.
---
