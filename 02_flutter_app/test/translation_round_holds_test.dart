...
void main() {
  ...
  test('⑤ والعتبةُ تُقاس، فلا تبقى «يوماً ما»', () {
    ...
    // ترجمة تدفقات البريد أعادت العدد دون الحد السابق للإضافة؛ لا نرفع
    // سقف الحارس لاستيعاب نصوص جديدة كان يجب وضعها في ملفات اللغة.
    expect(total, lessThanOrEqualTo(4536),
