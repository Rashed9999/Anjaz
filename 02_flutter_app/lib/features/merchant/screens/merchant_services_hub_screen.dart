      ...
      body: Obx(() {
        ...
        return ListView(
          ...
          children: [
            ...
            // AMIAL-WIRING-001: one owner entrypoint to the existing centre.
            // This is navigation, not a new entitlement or an employee grant.
            if (access.isMerchantOwner) ...[
              Card(
                child: ListTile(
                  leading: const Icon(Icons.hub_outlined, color: AmialColors.primary),
                  title: Text('مركز تشغيل المنشأة'.tr),
                  subtitle: Text('الأدوار والموظفون والأجهزة والورديات'.tr),
                  trailing: const Icon(Icons.chevron_left),
                  onTap: () => Get.to(() => const MerchantOperationsCenterScreen()),
                ),
              ),
