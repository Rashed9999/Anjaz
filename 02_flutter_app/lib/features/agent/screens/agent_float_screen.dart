          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text('المتبقي من حد الإيداع اليومي: $remaining ر.س',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _row('إيداعات للعملاء', '${today['cash_in_total'] ?? 0} ر.س',
              Icons.arrow_downward, const Color(0xFF10B981)),
          const Divider(height: 24),
          _row('سحوبات من العملاء', '${today['cash_out_total'] ?? 0} ر.س',
              Icons.arrow_upward, const Color(0xFFEF4444)),
          const Divider(height: 24),
          _row('شراء رصيد', '${today['topup_total'] ?? 0} ر.س',
              Icons.add_card, AmyalColors.primary),
          const Divider(height: 24),
          _row('العمولة', '${today['commission_earned'] ?? 0} ر.س',
