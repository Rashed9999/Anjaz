...
/// AMIAL-FUEL-VERTICAL-001 · المرحلة ٨ — **الحالاتُ الستّ في مكانٍ واحد**.
///
/// ══════════════════════════════════════════════════════════════════════
    ...
    return Obx(() {
      ...
      if (c.permissionDenied.value) {
        return _message(
          ...
          body: 'اطلب من مالك المحطة أو المدير منحك الصلاحية المناسبة.',
          showRetry: false,
        );
      }

      // ③ خطأ — برسالته ورقمِ خروجه.
        ...
        child: Column(
          ...
          children: [
            ...
            if (body.isNotEmpty) ...[
              ...
              Text(body,
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 14, color: AmialColors.textMuted)),
            ],
            if (showRetry) ...[
