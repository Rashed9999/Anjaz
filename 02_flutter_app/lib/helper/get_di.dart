...
import 'package:amial_pay/features/history/controllers/report_dispute_controller.dart';
...
import 'package:amial_pay/features/home/controllers/home_controller.dart';
import 'package:amial_pay/features/language/controllers/language_controller.dart';
...
import 'package:amial_pay/features/transaction_money/domain/reposotories/contact_repo.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  // ====== AMIAL v0.7-D: Legal + Zone + Recovery ======
  Get.lazyPut(() => AmialRepo(apiClient: Get.find()));
  Get.lazyPut(() => AmialController(repo: Get.find()), fenix: true);

  // ====== AMIAL v0.9-D: Receipts + Family Fund + Bill Pay ======
