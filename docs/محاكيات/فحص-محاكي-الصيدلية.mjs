...
// AMIAL-SIM-DRAWER-001: دُمج قسما الصيدليّة تحت «تشغيل الصيدلية» في المحاكي،
// وبقي هذا الفحصُ يطلب الاسمَ القديم «بيع الصيدلية والوصفات» فسقط. الفحصُ
// يتبع المحاكيَ لا العكس. (حارسٌ يطلب ما أُزيل عمداً يكذب.)
for (const s of ['تشغيل الصيدلية', 'البيع والتحصيل', 'الأدوية والمخزون',
